                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" type="text" name="tgl_transaksi" id="tgl_transaksi"
                                        class="form-control form-control-sm date" value="<?php echo e(date('d/m/Y')); ?>">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="jenis_transaksi" id="jenis_transaksi">
                                        ...
                                        <?php $__currentLoopData = $jenis_transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($jt->id); ?>">
                                                <?php echo e($jt->nama_jt); ?>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="bulan" id="bulan">
                                    ...
                                    <option <?php echo e(date('m') == '09' ? 'selected' : ''); ?> value="09">09. SEPTEMBER
                                    </option>
                                    <option <?php echo e(date('m') == '10' ? 'selected' : ''); ?> value="10">10. OKTOBER</option>
                                    <option <?php echo e(date('m') == '11' ? 'selected' : ''); ?> value="11">11. NOVEMBER
                                    </option>
                                    <option <?php echo e(date('m') == '12' ? 'selected' : ''); ?> value="12">12. DESEMBER
                                    </option>
                                </select>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="tanggal" id="tanggal">
                                    <option value="">--</option>
                                    <?php for($j = 1; $j <= 31; $j++): ?>
                                        <?php $no=str_pad($j, 2, "0" , STR_PAD_LEFT) ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\demo\resources\views/transaksi/jurnal_umum/index.blade.php ENDPATH**/ ?>