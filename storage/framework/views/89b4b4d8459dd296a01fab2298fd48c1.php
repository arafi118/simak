                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="avatar avatar-online">
                                <img src="<?php echo e(asset('/storage/profil/' . Session::get('foto'))); ?>" alt="avatar">
                            </span>
                            <span class="mr-1">
                                <span class="user-name text-bold-700"><?php echo e(Session::get('nama')); ?></span>
                            </span>
                        </a>
...
<?php /**PATH C:\laragon\www\demo\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>