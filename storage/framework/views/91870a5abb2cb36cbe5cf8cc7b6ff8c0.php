        ...
        <tbody>
            ...
            <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    <td align="center">
                        <div class="form-check text-center ps-0 mb-0">
                            <input class="form-check-input" type="checkbox" value="<?php echo e($trx->idt); ?>"
                                id="<?php echo e($trx->idt); ?>" name="cetak[]" data-input="checked">
                        </div>
                    </td>
...
<?php /**PATH C:\laragon\www\demo\resources\views/transaksi/jurnal_umum/partials/_jurnal.blade.php ENDPATH**/ ?>