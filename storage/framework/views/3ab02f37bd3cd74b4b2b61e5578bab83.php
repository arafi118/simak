<?php if($relasi): ?>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input autocomplete="off" type="number" name="jumlah" id="jumlah" class="form-control form-control-sm">
...
<div class="col-sm-4">
    <div class="form-group">
        ...
        <input autocomplete="off" type="number" name="umur_ekonomis" id="umur_ekonomis"
            class="form-control form-control-sm">
...
<?php /**PATH C:\laragon\www\demo\resources\views/transaksi/jurnal_umum/partials/form_inventaris.blade.php ENDPATH**/ ?>