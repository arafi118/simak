...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo e($logo); ?>">
    <link rel="icon" type="image/png" href="<?php echo e($logo); ?>">
    <title>
        SIDBM &mdash; <?php echo e($kec->nama_lembaga_sort); ?>

    </title>
    <link rel="apple-touch-icon" href="<?php echo e($logo); ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e($logo); ?>">
    <link
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-5 col-12 p-0">
                            <div class="card border-grey border-lighten-3 m-0 card-account-right height-400 shadow">
                                <div class="card-body p-3">
                                    <p class="text-center h5 text-capitalize"><?php echo e($kec->nama_lembaga_sort); ?></p>
                                    <p class="mb-3 text-center">
                                        <?php echo e($kec->sebutan_kec); ?> <?php echo e($kec->nama_kec); ?>
                                    ...
                                    <form class="form-horizontal form-signin" action="/login" method="post">
                                        ...
                                        <div class="text-center">
                                            &copy; <?php echo e(date('Y')); ?> PT. Asta Brata Teknologi
                                        </div>
                                        <p class="text-center">
                                            <?php echo e(str_pad($kec->id, 4, '0', STR_PAD_LEFT)); ?>
...
<?php /**PATH C:\laragon\www\demo\resources\views/auth/login.blade.php ENDPATH**/ ?>