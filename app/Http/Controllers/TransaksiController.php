...
class TransaksiController extends Controller
{
    ...
    public function jurnalTutupBuku()
    {
        ...
        $title = 'Tutup Buku';
        return view('transaksi.tutup_buku.index')->with(compact('title', 'usaha'));
    }
    ...
    public function simpanTutupBuku(Request $request)
    {
        ...
        return view('transaksi.tutup_buku.tutup_buku')->with(compact('title', 'kec', 'surplus', 'pembagian_surplus', 'tgl_kondisi', 'tahun', 'migrasi_saldo', 'cadangan_resiko', 'success'));
    }
    ...
    public function rekening($id)
    {
        ...
        // 1. MENAMBAH ASET
        if ($id == 1 && $akunModel === Accounts::class) {
        ...
        // 2. ASET KELUAR
        elseif ($id == 2 && $akunModel === Accounts::class) {
        ...
        // 3. PINDAH SALDO
        // (BEBAS, HANYA GESER)
        elseif ($id == 3 && $akunModel === Accounts::class) {
            ...
            if (Keuangan::startWith($disimpan_ke, '1.2.01') || Keuangan::startWith($disimpan_ke, '1.2.03')) {
                ...
                if ($jenis_transaksi == 1) {
                    if (!empty($disimpan_ke)) {
                        $keterangan_transaksi = $rek_sumber->nama_akun . " ke " . $rek_simpan->nama_akun;
                    }
