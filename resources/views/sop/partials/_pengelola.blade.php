        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="sebutan_pengawas" id="sebutan_pengawas"
                    class="form-control form-control-sm" value="{{ $kec->nama_bp_long }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="sebutan_verifikator" id="sebutan_verifikator"
                    class="form-control form-control-sm" value="{{ $kec->nama_tv_long }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="kepala_lembaga" id="kepala_lembaga"
                    class="form-control form-control-sm" value="{{ $kec->sebutan_level_1 }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="kabag_administrasi" id="kabag_administrasi"
                    class="form-control form-control-sm" value="{{ $kec->sebutan_level_2 }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="kabag_keuangan" id="kabag_keuangan"
                    class="form-control form-control-sm" value="{{ $kec->sebutan_level_3 }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="bkk_bkm" id="bkk_bkm"
                    class="form-control form-control-sm" value="{{ $kec->disiapkan }}">
