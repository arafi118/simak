    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="kd_kec" id="kd_kec"
                    class="form-control form-control-sm" value="{{ $kec->kd_kec }}" readonly>
        ...
        <div class="col-md-8">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="nama_bumdesma" id="nama_bumdesma"
                    class="form-control form-control-sm" value="{{ $kec->nama_lembaga_sort }}">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="tanggal_npwp" id="tanggal_npwp"
                    class="form-control form-control-sm date" value="{{ Tanggal::tglIndo($kec->tgl_npwp) }}">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="nomor_badan_hukum" id="nomor_badan_hukum"
                    class="form-control form-control-sm" value="{{ $kec->nomor_bh }}">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="telpon" id="telpon"
                    class="form-control form-control-sm" value="{{ $kec->telpon_kec }}">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input autocomplete="off" type="email" name="email" id="email"
                    class="form-control form-control-sm" value="{{ $kec->email_kec }}">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="alamat" id="alamat" class="form-control form-control-sm" placeholder="Alamat">{{ $kec->alamat_kec }}</textarea>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="web_utama" id="web_utama"
                    class="form-control form-control-sm" value="{{ $kec->web_kec }}" readonly>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="web_alternatif" id="web_alternatif"
                    class="form-control form-control-sm" value="{{ $kec->web_alternatif }}" readonly>
