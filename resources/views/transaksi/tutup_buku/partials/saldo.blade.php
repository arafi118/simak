                ...
                <table class="table table-striped">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="text-right">Rp. {{ number_format($total_saldo, 2) }}</th>
                        </tr>
                        @if ($lev1->lev1 == '3')
                            <tr>
                                <th colspan="2">Jumlah Liabilitas + Ekuitas</th>
                                <th class="text-right">Rp. {{ number_format($liabilitas, 2) }}</th>
                            </tr>
                        @endif
                    </tfoot>
                </table>
...
<form action="/transaksi/tutup_buku" method="post" id="FormSimpanTutupBuku">
    ...
    <div class="card">
        <div class="card-body p-2 d-flex justify-content-end">
            <button type="submit" id="SimpanTutupBuku" class="btn btn-info btn-sm mb-0">
